...
A browser extension that captures URLs from any webpage and appends them as bookmark blocks to a specified Notion page. Built with React and TypeScript.

## Features

- ✅ Captures current tab URL and title automatically
- ✅ Appends bookmarks directly to your chosen Notion page
- ✅ Clean settings interface for Notion API configuration
...
Instead of creating database entries, this extension appends bookmark blocks directly to any Notion page you specify. Each bookmark includes:

- **URL**: The webpage address
- **Title**: The page title (when available)
- **Preview**: Automatic link preview generated by Notion

## Quick Start

1. **Install the extension** (see Installation section below)
2. **Set up Notion integration** following our [setup guide](NOTION_SETUP.md)
3. **Configure the extension** with your API key and page ID
4. **Start bookmarking** - click the extension icon on any page and hit "Add to Notion Page"
...
2. Get your page ID from the Notion page URL
3. Share your target page with the integration
4. Configure the extension with your API key and page ID
